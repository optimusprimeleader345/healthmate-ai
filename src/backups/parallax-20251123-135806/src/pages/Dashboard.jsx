...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F5F7FA] px-6 pt-4 pb-8 space-y-8 animate-fadeIn">
      <SystemStatusBar offline={offline} lastSync={lastSync} />
      <DynamicIsland events={[]} />
      <div className="h-14"></div>
      <div className="mt-2 md:mt-4 parallax-subtle parallax-subtle">
        <SectionHeader
...
<div className="glass-card p-6 fade-in parallax">
  <div className="flex items-center justify-between">
    <div>
      <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">Welcome back 👋</h1>
      <p className="text-sm text-gray-600 dark:text-gray-400">Your personalized health updates are ready.</p>
    </div>
    <div className="flex gap-4">
      <div className="glass-card p-3">
        <span className="text-xs opacity-70">Daily Score</span>
        <div className="text-lg font-bold text-teal-500">87</div>
      </div>
    </div>
  </div>
</div>
