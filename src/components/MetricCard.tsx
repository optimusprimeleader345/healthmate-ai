...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <Card className={`p-6 bg-gradient-to-br from-white to-[#F1F5F9] backdrop-blur-xl border border-white/40 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] hover:-translate-y-1 parallax-subtle parallax-micro ${className}`}>
